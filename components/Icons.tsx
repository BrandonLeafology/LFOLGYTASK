...
export const EODIcon: React.FC<{className?: string, solid?: boolean}> = ({className, solid}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill={solid ? "currentColor" : "none"} stroke="currentColor">
        <path fillRule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-2-2H6zm3.707 3.707a1 1 0 00-1.414-1.414L5 7.586V11h2V8.414l1.293-1.293a1 1 0 000-1.414zM11 6a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" />
    </svg>
);

export const AskIcon: React.FC<{className?: string, solid?: boolean}> = ({className, solid}) => (
...
export const IgnoreIcon: React.FC<{className?: string}> = ({className}) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a9.97 9.97 0 01-1.563 3.029m-2.245-2.245a4.5 4.5 0 00-6.364-6.364" />
  </svg>
);
...
export const FlagIcon: React.FC<{className?: string; solid?: boolean}> = ({className, solid}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill={solid ? "currentColor" : "none"} stroke="currentColor">
...
export const BrainIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 13.5c0 .563-.213 1.083-.586 1.487l-.547.547a2.5 2.5 0 103.536 3.536l.547-.547c.373-.373.586-.893.586-1.487V13.5M12 12a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
